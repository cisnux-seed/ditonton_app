...
void main() {
  ...
  group('Now Playing Movies', () {
    ...
    group('when device is online', () {
      ...
      test(
        ...
        // assert
        verify(mockRemoteDataSource.getNowPlayingMovies());
        verify(mockLocalDataSource.cacheNowPlayingMovies([tMovieCache]));
      });
    ...
    group('when device is offline', () {
      ...
      test('should return cached data when device is offline', () async {
        ...
        when(mockLocalDataSource.getCachedNowPlayingMovies())
            .thenAnswer((_) async => [tMovieCache]);
        // act
        final result = await repository.getNowPlayingMovies();
        // assert
        verify(mockLocalDataSource.getCachedNowPlayingMovies());
        final resultList = result.getOrElse(() => []);
        expect(resultList, [tMovieFromCache]);
      });
  ...
  group('Popular Movies', () {
    ...
    group('when device is online', () {
      ...
      test(
        ...
        // assert
        verify(mockRemoteDataSource.getPopularMovies());
        verify(mockLocalDataSource.cachePopularMovies([tMovieCache]));
      });
  ...
  group('Top Rated Movies', () {
    ...
    group('when device is online', () {
      ...
      test(
        ...
        // assert
        verify(mockRemoteDataSource.getTopRatedMovies());
        verify(mockLocalDataSource.cacheTopRatedMovies([tMovieCache]));
      });
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(mockLocalDataSource.insertWatchlistMovies(tMovieTable))
          .thenAnswer((_) async => 'Added to Watchlist');
      // act
      final result = await repository.saveWatchlistMovies(tMovieDetail);
      // assert
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource.removeWatchlistMovies(tMovieTable))
          .thenAnswer((_) async => 'Removed from watchlist');
      // act
      final result = await repository.removeWatchlistMovies(tMovieDetail);
      // assert
